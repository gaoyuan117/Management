...
public class FenLiaoMingXiItemAdapter extends BaseAdapter {
    private List<FenLiaoMingXiBean.FenliaodanListBean.VoFenliaodanItemListBean> mList;
    private Context context;
    private String time, fenUser;

    public FenLiaoMingXiItemAdapter(List<FenLiaoMingXiBean.FenliaodanListBean.VoFenliaodanItemListBean> mList, Context context, String time, String fenUser) {
        this.mList = mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FenLiaoMingXiBean.FenliaodanListBean.VoFenliaodanItemListBean bean = mList.get(position);
